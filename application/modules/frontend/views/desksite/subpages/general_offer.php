...
<body>
	...
	<div id="Layer99_Container" style="width:332px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
		...
		<span style="color:#C0C0C0;font-family:Georgia;font-size:12px;" id="msg_cont"></span></div>
		...
		<span style="color:#FFFFFF;font-family:Georgia;font-size:13px;"><a href="#" class="style5_99" onclick="ShowObject('Layer99', 0);window.close();return false;">OK</a></span></div>
		</div>
	</div>
</div>
