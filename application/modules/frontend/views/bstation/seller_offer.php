...
<div id="wb_Text139" style="position:absolute;left:36px;top:133px;width:118px;height:14px;z-index:256;text-align:left;">
...
<span style="color:#303030;font-family:Georgia;font-size:13px;"><strong><?php echo isset($post[0]['name_prefix'])?:'';?> <?php echo isset($post[0]['name'])?:'';?> </strong></span></div>
<div id="wb_Text142" style="position:absolute;left:90px;top:98px;width:400px;height:16px;z-index:28;text-align:left;">
<span style="color:#303030;font-family:Georgia;font-size:13px;"><strong><?php echo isset($post[0]['company_name'])?:'';?> </strong></span></div>
<div id="wb_Text143" style="position:absolute;left:155px;top:131px;width:330px;height:16px;z-index:29;text-align:left;">
<span style="color:#303030;font-family:Georgia;font-size:13px;"><strong><?php echo isset($post[0]['title'])?:'';?></strong></span></div>
...
<input type="hidden" name="post_id" value="<?php echo isset($post[0]['id'])?:'';?>" />
<input type="hidden" name="post_type" id="post_type" value="1" />
<input type="hidden" name="product_id" id="product_id" value="0" />
<input type="hidden" name="busi_id" value="<?php echo isset($post[0]['busi_id'])?:'';?>" />
