  		...
  		<div id="inquiry_div"  text-align="center" style="padding-left: 20%;padding-bottom:50px;">
  				<div class="row">
  					...
  					<div class="col-md-12" style="padding-left: 40px;">
  						<input type="hidden" name="requester_busi_id" id="requester_busi_id" value="<?php echo $this->session->userdata('tsuser')['busi_id'];?>"  />
  						<input type="hidden" name="busi_id" id="busi_id" value="<?php echo $offerdata[0]['offer_sender_id'];?>"  />
  						<span style="color:#3C3C3C;font-family:Arial;font-size:12px;">To&nbsp;<font size="4px;"><strong><?php echo $contact_details[0]['company_name'];?></strong></font><br></span>
  					</div>
  				</div>
  				<div class="row">
  					<div class="col-md-12" style="padding-left: 40px;">
