...
<form name="newspecialservicefrm" id="newspecialservicefrm" action="" method="post">
<div class="panel-heading custom-panel-heading" style="text-align:left;padding-top: 5px !important;text-align:center;">
	...
	<b><input type="submit" name="newspsubmitbtn" id="newspsubmitbtn" class="btn-custom-product btn" value="Save & Add" style="height:28px;"/></b>
		...
		<div class="col-sm-12">
			<div class="row" style="margin-top:15px;">
		  		<div class="col-sm-12" style="text-align:left;">
					<div style="margin-bottom:10px;"><span style="color:#2D2D2D;font-family:Georgia;font-size:21px;">Add Special Services..</span></div>
						...
						<div class="row">
							<div class="col-sm-12" style="padding:0px;margin-bottom:0px;">
								...
								<div class="form-group col-sm-5" >
									<div class="">
										<input type="text" name="main_service[]" id="ds_main_service_1" class="ds-product-input" placeholder="Article Headline" style="width:400px;" maxlength="75"/>
									</div>
								...
								<div class="form-group col-sm-5" style="margin-left:12px;padding-left:11px;">
									<span class="input-required">*</span>
									<div class="">
										<select name="shipping_cate_id[]" id="shipping_cate_id" class="select-dropdown" style="width:288px;">
							...
							<div class="col-sm-12" style="padding:0px;margin-bottom:0px;">
								...
								<div class="form-group col-sm-6" >
									<div class="">
										<textarea name="description[]" rows="6" cols="68" class="custom-textarea" placeholder="Description" onkeydown="getMyText(this,1);" style="width:480px;" maxlength="4000"></textarea>
									</div>
									<div class="messageContainer"></div>
								</div>
								<div class="col-sm-3">
