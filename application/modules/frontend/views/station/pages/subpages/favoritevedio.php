...
#RollOver64:hover .image_container
{
...
#RollOver64 .front, #RollOver64 .back
{
   position: absolute;
}
#RollOver64 img
...
#RollOver65:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver65 .front, #RollOver65 .back
{
   position: absolute;
}
#RollOver65 img
...
#RollOver66:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver66 .front, #RollOver66 .back
{
   position: absolute;
}
#RollOver66 img
...
#RollOver67:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver67 .front, #RollOver67 .back
{
   position: absolute;
}
#RollOver67 img
...
#RollOver68:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver68 .front, #RollOver68 .back
{
   position: absolute;
}
#RollOver68 img
...
#RollOver69:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver69 .front, #RollOver69 .back
{
   position: absolute;
}
#RollOver69 img
...
#RollOver70:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver70 .front, #RollOver70 .back
{
   position: absolute;
}
#RollOver70 img
...
#RollOver71:hover .image_container
{
   -webkit-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -moz-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
   -ms-transform: rotateX(180deg) rotateY(180deg) rotateZ(180deg);
...
#RollOver71 .front, #RollOver71 .back
{
   position: absolute;
}
#RollOver71 img
...
if(count($favoritevedio) > 0 && $favoritevedio[0]['id'] !='') { 
		$i =1; foreach($favoritevedio as $key=>$video){ 
		  ?>
		  <div class="col-sm-1 chkbox-div text-center" style="padding-left:1px !important;width: 42px;">
				<input type="checkbox" id="chkseller-<?php echo $i;?>" onclick="toggleDeleteDive('btndelete-<?php echo $video['id'];?>','chkseller-<?php echo $i;?>');" name="chkseller-<?php echo $i;?>"  value="on" />
				<div id="btndelete-<?php echo $video['id'];?>" style="width: 24px; height: 34px; padding-top:10px;display:none;">
					<a href="#" onclick="delete_favorite(<?php echo $video['id'];?>,5);"><img src="<?php echo asset_url();?>images/delete.png" id="Image160" alt=""></a>
				</div>
			</div>	
				...
				<div id="Layer66" onmouseenter="showMenu('Layer8_<?php echo $key;?>');" onmouseleave="hideMenu('Layer8_<?php echo $key;?>');" style="background-color: #fafafa;border: 1px solid #d3d3d3;height: 350px;margin-left: 17px;padding: 20px 14px;width: 309px;z-index: 434;border-radius:0px;">
					<div>ss
						<span class="video-title">
							<strong><a href="<?php echo base_url();?>video/details/<?php echo $video['id'];?>" target="_blank" class="style16"><?php echo $video['product_name'];//$video['name']?></a></strong>
						</span>
					...
					<div class="padding-top-5">
						<span class="text-muted"><?php echo substr($video['description'], 0,90);?></span>
					</div>
...
max-width: 250px;"></video>
					...
					<div id="Layer8_<?php echo $key;?>" style="display: none;height: 75px;left: 1px;position: absolute;text-align: left;top: 274px;width: 318px;z-index: 168;">
						...
						<div style="background-color:#fff;opacity:1;z-index:24000;">
							...
							<?php  if(isset($_SESSION['tsuser']['category']) && $_SESSION['tsuser']['category']=='Shipper'){?>

								<a href="<?php echo base_url();?>shipper/profile/<?php echo $_SESSION['tsuser']['userid'];?>" target="_blank"> 
							...
							<div id="wb_Image4"	class="rollovershare">
								...
								<a href="javascript:shareToWorld('<?php echo base_url();?>item/details/<?php echo $video['id'];?>','<?php echo $video['name'];?>',2,<?php echo $video['id'];?>);">
								<img src="<?php echo asset_url();?>images/share-videoa.png" id="Image4" alt="">
							</a>
	    ...
	    <?php } } ?>
	    <span style="color:#C0C0C0;font-family:Georgia;font-size:12px;" id="msg_cont"></span>
<script>
...
function videoDetail(id) {
	$.get(base_url+"video/detail/"+id,{},function(data) {
