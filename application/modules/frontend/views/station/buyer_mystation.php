				...
				<div id="Layer1_Container" class="mystation_layer1_container">
					...
					<div id="wb_Image37" class="wb_img_37">
						<a href="#" onclick="getMyAccount();"> 
							...
							<?php if(file_exists(asset_url().$profile_img)) { ?>
							...
							<?php }else{ ?>
								<img src="<?php echo asset_url().'/images/Account2_new.png';?>" id="Image37" class="myaccountimg" alt="" style="width:50px;height:50px;" onmouseover="startWiggle(this);" onmouseleave="stopWiggle(this);">
							<?php } ?>
						</a>
					</div>
					...
					<div id="Layer337"
						...
						<div id="Layer337_Container"
							...
							<div id="wb_Text1166"
								...
								<span
									style="color: #2D2D2D; font-family: SimSun; font-size: 21px;">ä¸­æ–‡</span>
							</div>
							<div id="wb_Image241"
